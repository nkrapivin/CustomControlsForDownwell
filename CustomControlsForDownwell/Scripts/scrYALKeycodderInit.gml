// Taken from: https://yal.cc/key-code-to-key-name-and-vice-versa/
var l_k, l_c, l_s, l_slq, l_c2s, l_s2c;
l_c2s = ds_map_create();
l_s2c = ds_map_create();
global.keyboard_key_to_name = l_c2s;
global.keyboard_name_to_key = l_s2c;
l_c2s[?27] = "Escape";
l_s2c[?"mb_left"] = mb_left;
l_s2c[?"mb_right"] = mb_right;
l_s2c[?"mb_middle"] = mb_middle;
l_s2c[?"mb_none"] = mb_none;
l_s2c[?"mb_any"] = mb_any;
l_s2c[?"escape"] = 27;
l_s2c[?"esc"] = 27;
l_c2s[?32] = "Space";
